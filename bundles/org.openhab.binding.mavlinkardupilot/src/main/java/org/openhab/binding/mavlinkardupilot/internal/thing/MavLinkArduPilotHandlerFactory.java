...
import org.openhab.binding.mavlinkardupilot.internal.bridge.MavLinkArduPilotBridgeHandler;
...
public class MavLinkArduPilotHandlerFactory extends BaseThingHandlerFactory
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_BRIDGE.equals(thingTypeUID)) {
            MavLinkArduPilotBridgeHandler handler = new MavLinkArduPilotBridgeHandler((Bridge) thing);
            return handler;
        }
        ...
        if (BRIDGE_TYPE_SAMPLE.equals(thingTypeUID)) {
            return new MavLinkArduPilotBridgeHandler((Bridge) thing);
        }
